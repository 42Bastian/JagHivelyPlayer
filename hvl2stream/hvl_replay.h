...
struct hvl_voice
{
  ...
  // old RM
  int8					old_RM_was_active;
  int16					old_vc_RingAudioPeriod;
  uint8					old_vc_RingWaveform;
  int16					RM_was_used;
  // EDZ
  int8					old_octet1;
  int8					old_octet2;
  ...
  // valeurs pour comparaison, flag en bits
  int16                  old_vc_AudioVolume;
  uint8                  old_vc_Waveform;
  int16                  old_vc_SquarePos;
  uint16                 old_vc_WaveLength;
  int16                  old_vc_FilterPos;
  int16                  old_vc_AudioPeriod;
  uint32                 old_vc_Pan;
